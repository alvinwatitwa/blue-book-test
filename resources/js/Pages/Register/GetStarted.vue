...
<template>
    <Layout>
        ...
        <section>
            ...
            <button class="flex items-center justify-center w-full px-6 py-4 mt-4 text-center text-gray-900 bg-gray-100 rounded-lg max-md:px-5 max-md:max-w-full" aria-label="Continue with Google">
